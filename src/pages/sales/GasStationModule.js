...
import ProductGasSearchForSale from '../../components/ProductGasSearchForSale';
...
function GasStationModule(props) {
  ...
  const [openProductGasSearchForSale, setOpenProductGasSearchForSale] = useState(false);
  const [productSearchGasFilter, setProductSearchGasFilter] = useState('');
  const [productSearchGasPriceScale, setProductSearchGasPriceScale] = useState('');
  ...
  return (
    <Wrapper>
      ...
      <Row gutter={[8, 4]} style={{ width: '100%' }}>
        ...
        <Col span={18}>
          <p style={{ margin: '0px', fontSize: 12 }}>{'Combustibles (Precio Normal):'}</p>
          <Space wrap align='end' direction='horizontal'>
            <Button
              onClick={() => {
                setProductSearchGasFilter('REGULAR01');
                setProductSearchGasPriceScale(1);

                setTimeout(() => {
                  setOpenProductGasSearchForSale(true);
                }, 250);
              }}
            >
              <Space>
                <GPetrol1Icon width={'20px'} />
                {'Regular 1'}
              </Space>
            </Button>
            <Button
              onClick={() => {
                setProductSearchGasFilter('SUPER01');
                setProductSearchGasPriceScale(1);
            ...
            >
              <Space>
                <GPetrol2Icon width={'20px'} />
                {'Super 1'}
              </Space>
            </Button>
            <Button
              onClick={() => {
                setProductSearchGasFilter('DIESEL01');
                setProductSearchGasPriceScale(1);
        ...
        <Col span={6} />
        {/* <Col span={18}>
          <p style={{ margin: '0px', fontSize: 12 }}>{'Combustibles (Precio Descuento):'}</p>
          <Space wrap align='end' direction='horizontal'>
            <Button
              onClick={() => {
                setProductSearchGasFilter('REGULAR01');
                setProductSearchGasPriceScale(2);
      ...
      />
      <ProductGasSearchForSale
        open={openProductGasSearchForSale}
        distributionType={productDistributionType}
        priceScale={productSearchGasPriceScale}
        productFilterSearch={productSearchGasFilter}
        allowOutOfStock={true}
        onClose={(saleDetailToPush, executePush, currentStock) => { 
          setOpenProductGasSearchForSale(false);
          // const { detailId, detailName, detailQuantity, detailIsService } = saleDetailToPush;
