...
import { Button, Col, DatePicker, Divider, Input, InputNumber, Row, Select, Table, Modal, Space, Tag, Result, Radio, Alert, Drawer, Comment, Avatar } from 'antd';
...
import { DeleteOutlined, DollarCircleOutlined, EditOutlined, HomeOutlined, InfoCircleTwoTone, InfoOutlined, PhoneOutlined, SaveOutlined, UserAddOutlined } from '@ant-design/icons';
  ...
  async function createNewSale(userPINCode) {
    ...
    try {
      ...
      const saleResponse = await salesServices.add(
        ...
        userPINCode,
        numberToLetters(Number(getDetailTotal().toFixed(2)) || 0.00)
      );
