...
class SaleTicket extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <TicketWrapper>
        ...
        <Row gutter={8}>
          ...
          <Col span={16}><p className="col-body-right">{`${ticketData.documentTypeName || '-'}`}</p></Col>
        </Row>
        <Row gutter={8}>
        ...
        <div className="divider" />
        <Row gutter={8}>
          <Col span={18}><p className="col-body-left">{`Venta total:`}</p></Col>
